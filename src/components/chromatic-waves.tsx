...
import { Renderer, Camera, Mesh, Plane, Program, RenderTarget as OglRenderTarget } from "ogl"
...
export default function DottedBg2({
  ...
  const renderOnce = () => {
    ...
    if (!renderer || !camera || !perlinMesh || !dotMesh || !renderTarget || !gl || !dotProgram)
      return
  ...
  useEffect(() => {
    ...
    if (perlin) {
      ...
      perlin.uniforms.uSpeed.value = effectivePlay ? mapSpeedUiToShader(speed) : 0
    }
